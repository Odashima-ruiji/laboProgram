/*
    placement_angle_80_20.c : 角度ベース配置に関する関数 (実装)
    80%が中心方向(move_flag=10), 20%が外側エリア（角度ベース等分割配置）
*/
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
#include "placement_angle_80_20.h"
...
{
    /* 外側ノード数 (20%) と中心方向ノード数 (80%) */
    int num_outer = N_ALL_NUM * 2 / 10;
