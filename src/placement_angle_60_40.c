/*
    placement_angle_60_40.c : 角度ベース配置に関する関数 (実装)
    60%が中心方向(move_flag=10), 40%が外側エリア（角度ベース等分割配置）
*/
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
#include "placement_angle_60_40.h"
...
{
    /* 外側ノード数 (40%) と中心方向ノード数 (60%) */
    int num_outer = N_ALL_NUM * 4 / 10;
